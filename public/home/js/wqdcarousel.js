define(function() {
  ...
  Wqdcarousel.prototype.to = function (pos) {
    ...
    if (this.sliding)       return this.$element.one('slid.Wqdcarousel', function () { that.to(pos) }); // yes, "slid"
  ...
  Wqdcarousel.prototype.slide = function (type, next) {
    ...
    var slidEvent = $.Event('slid.Wqdcarousel', { relatedTarget: relatedTarget, direction: direction });// yes, "slid"
    if ($.support.transition && this.$element.hasClass('slide')) {
      ...
      $active.one('bsTransitionEnd', function () {
          ...
          var $activeItem=$("#myCarousel .item.active"),$close=$("#myCarousel .closeBtn");
          for(var i=0;i<10;i++){
            $close.removeClass("close_"+i);
            if($activeItem.find(".model_"+i).length) $close.addClass("close_"+i);
          };
          that.sliding = false;
          setTimeout(function () {

    ...
    <div class="authority">
        <div class="authority-head">
            <div class="manage-head">
                <h6 class="layout padding-left manage-head-con">新增文章分类
        ...
        <!--  表单start  -->
        <div class="form_main">
        <form class="layui-form layui-form-pane" action="{{url('admin/article/category/store')}}" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="category_title" lay-verify="required" placeholder="请输入文章分类标题" autocomplete="off" class="layui-input" style="width: 350px">
                </div>
            </div>
            <span class="clear_span" ></span>
            <div class="layui-form-item" pane="" style="width: 255px">
                ...
                <div class="layui-input-block" style="width: 255px">
                    <input type="radio" name="category_status" value="1" title="是" checked="">
                    <input type="radio" name="category_status" value="0" title="否">
                </div>
            </div>
            <span class="clear_span" ></span>
            <div class="layui-form-item">

    ...
    <div class="authority">
        <div class="authority-head">
            <div class="manage-head">
                <h6 class="layout padding-left manage-head-con">编辑文章分类
        ...
        <!--  表单start  -->
        <div class="form_main">
            <form class="layui-form layui-form-pane" action="{{url('admin/article/category/update/'.$data->category_id)}}" method="post">
                <input type="hidden" name="category_author" value="{{session('admin.user_id')}}">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block" style="width: 250px;">
                        <select name="category_fid" lay-filter="aihao" style="width: 250px;">
                            <option value="0">顶级分类</option>
                            @foreach($category as $v)
                            <option value="{{$v->category_id}}" @if($data->category_fid == $v->category_id) selected="selected" @endif>{{$v->category_title}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="category_title" lay-verify="required" value="{{$data->category_title}}" placeholder="请输入文章分类标题" autocomplete="off" class="layui-input" style="width: 350px">
                    </div>
                </div>
                <span class="clear_span" ></span>
                <div class="layui-form-item" pane="" style="width: 255px">
                    ...
                    <div class="layui-input-block" style="width: 255px">
                        <input type="radio" name="category_status" value="1" title="是" @if($data->category_status==1) checked="" @endif>
                        <input type="radio" name="category_status" value="0" title="否" @if($data->category_status==0) checked="" @endif>
                    </div>
                </div>
                <span class="clear_span" ></span>
                <div class="layui-form-item">

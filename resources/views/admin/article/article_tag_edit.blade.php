    ...
    <div class="authority">
        <div class="authority-head">
            <div class="manage-head">
                <h6 class="layout padding-left manage-head-con">编辑文章标签
        ...
        <!--  表单start  -->
        <div class="form_main">
            <form class="layui-form layui-form-pane" action="{{url('admin/article/tag/update/'.$data->tag_id)}}" method="post">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="tag_name" lay-verify="required" value="{{$data->tag_name}}" placeholder="请输入文章标签" autocomplete="off" class="layui-input" style="width: 350px">
                    </div>
                </div>
                ...
                <div class="layui-form-item" pane="" style="width: 255px">
                    ...
                    <div class="layui-input-block" style="width: 255px">
                        <input type="radio" name="tag_status" value="1" title="是" @if($data->tag_status==1) checked="" @endif>
                        <input type="radio" name="tag_status" value="0" title="否" @if($data->tag_status==0) checked="" @endif>
                    </div>
                </div>
                <span class="clear_span" ></span>
                <div class="layui-form-item">
